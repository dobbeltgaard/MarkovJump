...
//       obs(end)  = Type(1.0);
//       
//       vector<Type> mu(m-1); mu.setOnes();//compute_conditional_sojourn(A, start, end, u(i));
//       Type tau_eff = (mu * xi).sum();  // inner product: degradation-weighted time
//       
...
//       obs(end)  = Type(1.0);
//       
//       vector<Type> mu(m-1); mu.setOnes();//compute_conditional_sojourn(A, start, end, u(i));  // correct
//       Type tau_deg = (mu * xi).sum();  // degradation-weighted time
