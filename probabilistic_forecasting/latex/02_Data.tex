...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=\linewidth]{figures/defect_development.png}
...
As seen, the simulations terminate in different severity classes, reflecting the inherent uncertainty in degradation processes. When we generate forecasts, we aim to represent this uncertainty through a predictive distribution. A perfect forecast would assign all probability to the correct future state, but in practice, the model must distribute probability mass across possible outcomes.
